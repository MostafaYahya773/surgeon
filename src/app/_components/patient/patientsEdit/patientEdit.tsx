...
export const PatientEdit = ({
  ...
  const { endpoint, id, handleEdit, setEndpoint, isSubmitting } =
  ...
  const formik = useFormik<OperationReportFormValues>({
    initialValues: {
      ...
      patient_berth_date: data?.patient_berth_date || '',
      gender: data?.gender || '',
      ...
      surgeon_name: data?.consultant_name || '',
      anaesthetist_name: data?.consultant_name || '',
      assistant_name: data?.assistant_name || '',
      assistant_sn: data?.assistant_sn || '',
      ...
      incisions: data?.incisions || '',
      operative_findings: data?.operative_findings || '',

      tissue_removed: data?.tissue_removed || '',
      antibiotic_type: data?.antibiotic_type || '',
      estimated_blood_loss: data?.estimated_blood_loss || '',
      procedure: data?.procedure || '',
      operative_complications: data?.operative_complications || '',
      extra_procedure: data?.extra_procedure || '',
      abx_prophylaxis: data?.abx_prophylaxis || '',
      dvt_prophylaxis: data?.dvt_prophylaxis || '',

      closure: data?.closure || '',
      post_op: data?.post_op || '',
