...
import ChangeTheme from '@/app/_components/ChangeTheme/ChangeTheme';
export default function Setting() {
  ...
  return (
    <div className="p-5 flex flex-col lg:w-[70%] w-full mx-auto gap-5">
      {/* Profile Image */}
      ...
      <div className="information  h-fit dark:bg-slate-800 bg-white rounded-md p-3">
        <h4 className="dark:text-white text-[20px]">Personal Information</h4>
        <form
          onSubmit={formik.handleSubmit}
          className="inputs grid grid-cols-1 md:grid-cols-2 gap-3 mt-2"
        >
          ...
          <div className="md:col-span-2 mt-3 w-full">
            <button
              type="submit"
              disabled={isSubmitting}
              className="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition w-full md:w-1/4"
            >
