              ...
              <div className="flex flex-col gap-4">
                {LoginInputs.map((input, index) => (
                  <div className="input relative" key={index}>
                    <input
                      className="min-w-[300px] w-full p-2 px-8 rounded-lg outline-none text-[15px] border dark:border-slate-700 focus:dark:border-slate-500 focus:border-slate-400 dark:text-white dark:bg-slate-800"
                      type={input.type}
                      name={input.name}
