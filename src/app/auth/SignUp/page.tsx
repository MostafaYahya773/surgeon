...
export default function SignUp() {
  ...
  return (
    <div className="flex justify-center items-center mx-auto h-screen">
      <div className="dark:bg-slate-800 bg-white shadow-sm w-fit h-fit rounded-lg p-6">
          ...
          >
            ...
            {LoginInputs?.slice(0, 1).map((input, idx) => (
              <div className="input relative" key={idx}>
                <input
                  className="w-full p-2 px-8 rounded-lg outline-none text-[15px] border dark:border-slate-700 focus:dark:border-slate-500 focus:border-slate-400 dark:text-white dark:bg-slate-800"
                  type={input.type}
                  name={input.name}
                ...
                if (input.placeHolder === 'Birthdate') {
                  return (
                    <div className="input relative" key={idx}>
                      <input
                        ref={dateInputRef}
                        className="w-full p-2 px-8 rounded-lg outline-none text-[15px] border dark:border-slate-700    focus:dark:border-slate-500 focus:border-slate-400 dark:text-white dark:bg-slate-800 cursor-pointer"
                        type="text"
                        placeholder={input.placeHolder}
                        readOnly
                        value={
